public class Quiz05_Method {

	// 1. 위 문자열 안에서 A의 개수를 찾아서 반환하는 메서드=====================
...
//		String str = "ASLKVLNCLSAOLIVHOSDIHOFWEIJNFLAKSJFLSDKIHFOWEIFLAKSDHOKFAUJSGFIKQEJFA";

//		int rsA = countA(str);

//		System.out.println("A 는 총 " + rsA + "개");
...
//	}
	...
	// 2. 위 문자열 안에서 인자값으로 넘어오는 캐릭터값이 총 몇개인지 찾아서 반환하는 메서드=====================
...
//		int rsChar = countChar(str, "B");

//		System.out.println("B는 총 " + rsChar + "개");
...
//	}
	...
	// 3. 아래 문자열 안에서 Java가 몇개인지 찾아서 반환하는 메서드===============
...
//
//            if(strArr[i].equals("Java")) numJava++;
//
//       }
//
//        return numJava;
...
//		System.out.println("Java 는 총 " + rsJava + "개");
    public static void findJava(String str) {
        ...
        System.out.println("Java 는 총 " + numJava + "개");
